          ...
          <div className="row">
            <div className="col-4">
              ...
              <div>
                <address className="text-white fs-6">
                  Kailaras Morena (M.P) <br />
                  Pincode:- 476224
                </address>
                <a
                  href="tel: +91 6232697100"
                  className="mt-3 d-block mb-1 text-white"
                >
                  +91 6232697100
                </a>
                <a
                  href="Email: meenugarg7100@gmail.com"
                  className="mt-2 d-block mb-0 text-white"
                >
                  meenugarg7100@gmail.com
                </a>
            ...
            <div className="col-2">
              ...
              <div className="footer-links d-flex flex-column">
                ...
                <Link className="text-white mb-1 py-2">SmartWatch</Link>
              </div>
            </div>
          </div>
        </div>
