    ...
    <>
      ...
      <Container class1="famous-wrapper py-5 home-wrapper-2">
        <div className="row">
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              <img src="images/lepi.webp" className="img-fluid" alt="famous" />
              <div className="famous-content position-absolute">
          ...
          <div className="col-3">
            <div className="famous-card position-relative">
              <img
                src="images/smart-watch.webp"
                className="img-fluid"
                alt="famous"
              />
              <div className="famous-content position-absolute">
                <h5 className="text-dark">Smartwatch</h5>
                <h6 className="text-dark">Smartwatch 13Pro</h6>
                <p className="text-dark">
                  Now in Green. Fro $999.00 or$41.62/mo.for24mo. Footnote
                </p>
              </div>
            </div>
          </div>
